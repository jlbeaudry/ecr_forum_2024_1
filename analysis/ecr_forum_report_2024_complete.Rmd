...
Of the 62 early career researchers who attended this session, `r nrow(df)` 
...
#   geom_bar(position="fill", stat="identity", colour = "black") +
#   # add text to show the percentage numbers on the figure
#   geom_text(aes(y = percentage, x = training, label = percentage), position = position_fill(vjust = 0.7)) +
